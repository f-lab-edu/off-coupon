...
import com.flab.offcoupon.service.couponIssue.sync.CouponIssueFacade;
...
public class CouponIssueRequestService {
     ...
     * CouponIssueFacade를 구현한 클래스는 pessimisticLockCouponIssue, namedLockCouponIssue, lettuceLockCouponIssue, redissonLockCouponIssue가 있습니다.
     * 그 중에서 Redisson의 pub/sub기반인 RLock을 사용했습니다.
     *
     * AsyncCouponIssueServiceV1은 비동기식으로 쿠폰을 발급할때 사용하는 클래스입니다.
