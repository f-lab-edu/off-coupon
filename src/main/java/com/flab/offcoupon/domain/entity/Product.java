...
import com.flab.offcoupon.model.StrictPositiveBigDecimal;
...
public final class Product {
	...
	public Product(long id, String category, String title, String description, BigDecimal originalPrice,
		BigDecimal salePrice, BigDecimal minOrderPrice, LocalDateTime createdAt, LocalDateTime updatedAt) {
		this.id = new PositiveLong(id).getValue();
		this.category = category;
		this.title = title;
		this.description = description;
		this.originalPrice = new StrictPositiveBigDecimal(originalPrice).getValue();
		this.salePrice = new PositiveBigDecimal(salePrice).getValue();
		this.minOrderPrice = new StrictPositiveBigDecimal(minOrderPrice).getValue();
