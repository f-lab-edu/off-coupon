...
class RedissonLockCouponIssueTest {
    ...
    void issueCoupon_fail_with_invalid_eventId() {
        ...
        long memberId = 1L;
        // when
        assertThatThrownBy(() -> redissonLockCouponIssue.issueCoupon(currentDateTime, invalidEventId, couponId, memberId))
    ...
    void issueCoupon_fail_with_invalid_couponId() {
        ...
        long memberId = 1L;
        // when
        assertThatThrownBy(() -> redissonLockCouponIssue.issueCoupon(currentDateTime, eventId, invalidCouponId, memberId))
    ...
    void issueCoupon_success() throws InterruptedException {
        ...
        long memberId = 1L;
        // when
        ResponseDTO responseDTO = redissonLockCouponIssue.issueCoupon(currentDateTime, eventId, couponId, memberId);
