...
class RedissonLockCouponIssueTest {
    ...
    void issueCoupon_fail_with_invalid_eventId() {
        ...
        // when
        assertThatThrownBy(() -> redissonLockCouponIssue.issueCoupon(currentDateTime, parameter))
    ...
    void issueCoupon_success() throws InterruptedException {
        ...
        // when
        ResponseDTO responseDTO = redissonLockCouponIssue.issueCoupon(currentDateTime, parameter);
