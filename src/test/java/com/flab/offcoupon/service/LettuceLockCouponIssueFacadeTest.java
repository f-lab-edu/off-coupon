...
@SpringBootTest
class LettuceLockCouponIssueFacadeTest {
    @Autowired
    private LettuceLockCouponIssueFacade lettuceLockCouponIssueFacade;
    @Autowired
        ...
        for (int i = 0; i < threadCount; i++) {
            ...
            executorService.submit(() -> {
                try {
                    ...
                    lettuceLockCouponIssueFacade.issueCoupon(currentDateTime,1, 1,currentMemberId);
                } catch (Exception e) {
